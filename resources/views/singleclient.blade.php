...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <title>Single Client Info</title>
...
<div data-bs-theme="light"class="container">
    <div class="row" style="margin: 100px">
        ...
        <div class="">
            <p class="text-center h1 bg-info" style="padding:10px">{{$client->client_name}} Information</p>
...
<section style="background-color: #eee;">
  <div class="container py-3">
    <a class="" href="/viewclient"><button class="btn btn-success" style="margin-bottom: 10px" >All Clients</button></a>
    <div class="row">
      <div class="col">
      ...
      <div class="col-lg-4">
        <div class="card mb-4">
          <div class="card-body text-center">
            ...
            <h5 class="my-3">{{$client->client_name}}</h5>
            <p class="text-muted mb-4">{{$client->address}}</p>
             <p class="text-muted mb-4">(+88){{$client->phone}}</p>
        ...
        <div class="card mb-4">
          <div class="card-body" style="height: 392px; line-height:58px">
            <div class="row" style="">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0">{{$client->client_id}}</p>
              </div>
            </div>
            <hr>
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0">(+88) {{$client->phone}}</p>
              </div>
            </div>
            <hr>
            <div class="row">
              ...
              <div class="col-sm-9">
                <p class="text-muted mb-0">{{$client->contact_person}}</p>
              </div>
            </div>
          </div>
        </div>
